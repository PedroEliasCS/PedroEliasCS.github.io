...
function fixdim() {
	...
	if(dirty){
		...
		canvas.height = dimensions.height*1 -20
		canvas.style.height = dimensions.height -1000
	}
	return dirty
}
...
// funcao de stroll desativa 
// pq o tem espaço para acontecer
...
// 	let coolnewheight = Math.max(impoerialheight, top/(r.height - window.innerHeight))//1 - (r.bottom - window.innerHeight)/(r.height - window.innerHeight)//-rect.top/rect.height
